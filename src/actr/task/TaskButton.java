...
/**
 * The class that defines a button for a task interface. A subclass of this class can override
 * the <tt>doClick()</tt> method to specify the response to a mouse click.
 * 
...
public class TaskButton extends JButton implements TaskComponent
{
	...
	/**
	 * The method called when the button is clicked. This should be overridden to provide
