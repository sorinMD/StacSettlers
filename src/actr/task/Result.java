...
public class Result
{
	...
	private class Measure
	{
		...
		{
			if (resultString != null) return String.format ("%-20s", name) + resultString;
	...
	{
		OkMeasure (String name) { super (name, 0, 0, 0); resultString = "-ok-"; }
	}

	private class NotOkMeasure extends Measure
	{
		NotOkMeasure (String name) { super (name, 0, 0, 0); resultString = "XXXX"; }
	}
