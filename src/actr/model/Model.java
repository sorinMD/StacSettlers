...
public class Model
{
	...
	public double getTime() { return time; }
        ...
        /**
         * Increment the model time by 1s.
         * Can be used when setting the goal for the next run of the model.
         */
	...
	public String toString ()
	{
        ...
        /**
         * Set the goal focus by clearing all goals and putting the chunk into the goal buffer.
         * This is used for calling the model for short runs without resetting it, in particular its DM. 
         * It forces the model to have only one goal.
         * @param chunk  The chunk that's to become the goal focus.
         * @author Markus Guhe
         */
        public void setGoalFocus(Chunk chunk) {
            //System.err.println("Goals before: " + buffers.goals.toString());
            //incrementTime();
            buffers.clear(Symbol.goal);
            buffers.set(Symbol.goal, chunk);
            //System.err.println("Goals after: " + buffers.goals.toString());
        }
}
