...
//---MG	Chunk (Symbol name, Model model)
	...
	public Iterator<Symbol> getSlotValues() { return slots.values().iterator(); }
        ...
        /**
         * Get the value of the specified slot.
         * 
         * @param slot  the slot that's being queried
         * @return      the slot's value
         * @author      Markus Guhe
         */
        public Symbol getSlotValue(Symbol slot) {
            return slots.get(slot);
        }
        
//---MG	void set (Symbol slot, Symbol value)
