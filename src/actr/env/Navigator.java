	...
	Navigator (final Frame frame)
	{
		...
		commandCB.addActionListener (new ActionListener() {
			public void actionPerformed (ActionEvent e) {
				if (!disableAction) goToSelected (frame, (Marker) commandCB.getSelectedItem());
			}
		});
		...
		productionCB.addActionListener (new ActionListener() {
			public void actionPerformed (ActionEvent e) {
				if (!disableAction) goToSelected (frame, (Marker) productionCB.getSelectedItem());
			}
		});
		...
		chunkCB.addActionListener (new ActionListener() {
			public void actionPerformed (ActionEvent e) {
				if (!disableAction) goToSelected (frame, (Marker) chunkCB.getSelectedItem());
			}
		});
