...
//            //---MG
//          toWhom1.setText(names2);
//          toWhom2.setText(names1);
...
//---MG            offerBut.setVisible(false); //---MG offered && ! visible);
        ...
        /**
         * if trades are done via the chat interface and the trade panel will be only informative, this method should be called after updating offer
         */
        public void disableButtons(){
            ...
            hp.offerCounterOfferVisibleChanged(false);
            validate();
        }
