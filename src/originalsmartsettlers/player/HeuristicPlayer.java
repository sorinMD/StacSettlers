...
//        rnd = new Random(2);
    ...
    public void selectAction(int[] s, int [] a)
    {
        ...
        for (j=0; j<bl.possibilities.n; j++)
        {
            ...
            String string = String.format("%2d: [%d %d %d %d %d]  w:%f\n", j, a2[0], a2[1], a2[2], a2[3], a2[4], bl.possibilities.weight[j]);
            D.ebugPrintlnINFO(string);
        }
        D.ebugPrintINFO("\n==========\n");
